...
class AppColors {
  ...
  /// Light
  static const Color primaryColorLight = Colors.deepOrangeAccent;
  static const Color accentColorDark = Color(0xFF53ac6d);
  ...
  /// Dark
  static const Color accentColorLight = Color(0xFF494955);
  static const Color primaryColorDark = Color(0xFFabb2bf);
