...
import 'package:buy_luck/core/common/app_options/app_options.dart';
...
import 'package:buy_luck/core/theme/theme_config.dart';
...
class AppConfig {
  ...
  ThemeData themeData(String fontName) => _appTheme == AppThemes.LIGHT
      ? getIt<ThemeConfig>().lightTheme(fontName)
      : getIt<ThemeConfig>().darkTheme(fontName);
  ...
  static Size screenUtilDesignSize() {
    if (Device.get().isTablet) return const Size(1080, 1920);
