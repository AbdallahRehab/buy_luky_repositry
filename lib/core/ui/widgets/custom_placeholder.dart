...
class _CustomPlaceHolderState extends State<CustomPlaceHolder> {
  var colors = [
    Color.fromARGB(255, 164, 145, 189),
    Color.fromARGB(255, 132, 102, 172),
    Color.fromARGB(255, 253, 208, 5),
    Color.fromARGB(255, 166, 137, 8),
    Color.fromARGB(255, 87, 175, 201),
    Color.fromARGB(255, 3, 73, 94),
    Color.fromARGB(255, 228, 148, 114),
    Color.fromARGB(255, 227, 80, 18),
  ];
