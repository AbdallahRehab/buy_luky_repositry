...
import 'package:buy_luck/core/net/models_factory.dart';
import 'package:buy_luck/core/net/response_validators/default_response_validator.dart';
import 'package:buy_luck/core/net/response_validators/list_response_validator.dart';
  ...
  Future<Either<AppErrors, T>> requestUploadFile<T extends BaseModel>({
    ...
    if (response.isLeft()) {
      ...
      try {
        ...
        e.toString().logE;
        return Left(
            const CustomError(message: "Catch error in remote data source"));
      }
    } else {
